document.addEventListener('DOMContentLoaded', async() => {
    ...
    const createTaskCard = (task) => {
        ...
        card.innerHTML = `<p class="task-card-text">${task.text}</p><div class="task-card-footer"><span class="priority-tag priority-${task.priority || 'normal'}">${priorityText}</span></div>`;
        return card;
    };
